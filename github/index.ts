...
import { createOpencodeClient } from "@abov3-ai/sdk"
...
function useShareUrl() {
  return isMock() ? "https://dev.abov3.ai" : "https://abov3.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.abov3.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.abov3.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
