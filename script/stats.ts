...
console.log("Fetching GitHub releases for fajardofahad/abov3-genesis-codeforger...\n")
...
console.log("Fetching npm all-time downloads for abov3...\n")
const npmDownloads = await fetchNpmDownloads("abov3")
