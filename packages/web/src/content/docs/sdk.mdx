title: SDK
description: Type-safe JS client for the ABOV3 server.

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The ABOV3 JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control abov3 programmatically.
...
You can also programmatically start an abov3 server:

```javascript
import { createOpencodeServer } from "@abov3-ai/sdk"
...
You can pass a configuration object to customize server behavior. The server still picks up your `abov3.json`, but you can override or add configuration inline:
...
```typescript
import type { Session, Message, Part } from "@abov3-ai/sdk"
```
