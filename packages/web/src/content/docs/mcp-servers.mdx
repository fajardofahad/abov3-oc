...
You can add external tools to abov3 using the _Model Context Protocol_, or MCP. abov3 supports both:
...
You can define MCP servers in your abov3 config under `mcp`.
...
```json title="abov3.json" {11, 14-17}
{
  "$schema": "https://abov3.ai/config.json",
  "mcp": {
    "my-mcp": {
