...
By default, abov3 **allows all operations** without requiring explicit approval.
...
Permissions are configured in your `abov3.json` file under the `permission` key. Here are the available options.
