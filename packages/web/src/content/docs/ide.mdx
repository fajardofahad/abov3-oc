---
title: IDE
description: The abov3 extension for VS Code, Cursor, and other IDEs
---

abov3 integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `abov3` in the terminal to get started.
...
-- **Context Awareness**: Automatically share your current selection or tab with abov3.
...
To install abov3 on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `abov3` - the extension installs automatically

---

### Manual Install

Search for **abov3** in the Extension Marketplace and click **Install**.
...
- Ensure youre running `abov3` in the integrated terminal.
