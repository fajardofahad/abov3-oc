---
title: TUI
description: Using the abov3 terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

abov3 provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running abov3 starts the TUI for the current directory.
...
When using the abov3 TUI, you can type `/` followed by a command name to quickly execute actions. For example:
