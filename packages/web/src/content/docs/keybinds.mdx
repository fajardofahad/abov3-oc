...
abov3 has a list of keybinds that you can customize through the abov3 config.
...
abov3 uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
